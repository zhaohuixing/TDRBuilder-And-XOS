...
#ifndef __TDOM_MSDOMADPTOR_INL__
#define __TDOM_MSDOMADPTOR_INL__

template<typename TXMLData>
TDOM_MSDOMAdaptorBase<TXMLData>::TDOM_MSDOMAdaptorBase()
{
...
template<typename TXMLData>
bool TDOM_MSDOMAdaptorBase<TXMLData>::Initialize(void)
{
	if(m_bInitialized)
...
template<typename TXMLData>
void TDOM_MSDOMAdaptorBase<TXMLData>::UnInitialize(void)
{
	if(m_bInitialized)
	{
...
template<typename TXMLData>
bool TDOM_MSDOMAdaptorBase<TXMLData>::Load(const wchar_t* szURL)
{
...
template<typename TXMLData>
bool TDOM_MSDOMAdaptorBase<TXMLData>::Save(const wchar_t* szURL)
{
	if(!m_bInitialized || !szURL) 
		return false;
...
template<typename TXMLData>
bool TDOM_MSDOMAdaptorBase<TXMLData>::Reset(void)
{
	UnInitialize();
	return Initialize();
}
...
template<typename TXMLData>
bool TDOM_MSDOMAdaptorBase<TXMLData>::SetNodeName(XDOM_NODE_PTR& ptrParent, 
...
template<typename TXMLData>
bool TDOM_MSDOMAdaptorBase<TXMLData>::GetNodeName(XDOM_NODE_PTR& ptrNode, 
								   std::wstring& strName)
{
	if(!ptrNode.p) 
		return false;
...
template<typename TXMLData>
bool TDOM_MSDOMAdaptorBase<TXMLData>::SetNodeText(XDOM_NODE_PTR& ptrNode, const wchar_t* lpszText)
{
	if (!ptrNode.p || !lpszText) 
		return false;
...
template<typename TXMLData>
bool TDOM_MSDOMAdaptorBase<TXMLData>::GetNodeText(XDOM_NODE_PTR& ptrNode, std::wstring& strText)
{
	if(!ptrNode.p) 
		return false;
...
template<typename TXMLData>
bool TDOM_MSDOMAdaptorBase<TXMLData>::SetNodeValue(XDOM_NODE_PTR& ptrNode, const wchar_t* lpszValue)
{
...
template<typename TXMLData>
bool TDOM_MSDOMAdaptorBase<TXMLData>::GetNodeValue(XDOM_NODE_PTR& ptrNode, std::wstring& strValue)
{
	if(!ptrNode.p) 
		return false;
...
template<typename TXMLData>
bool TDOM_MSDOMAdaptorBase<TXMLData>::GetNodeType(XDOM_NODE_PTR& ptrNode, MSXML2::DOMNodeType& nodeType)
{
	bool ret = false;
...
template<typename TXMLData>
XDOM_NODE_PTR TDOM_MSDOMAdaptorBase<TXMLData>::CreateDOMChildNode(XDOM_NODE_PTR& ptrNode, 
...
template<typename TXMLData>
XDOM_ATTR_PTR TDOM_MSDOMAdaptorBase<TXMLData>::CreateDOMNodeAttribute(XDOM_NODE_PTR& ptrNode, 
												const wchar_t* lpszName, 
...
template<typename TXMLData>
XDOM_DOC_PTR& TDOM_MSDOMAdaptorBase<TXMLData>::GetDOMDocument(void)
{
	return m_ptrDoc;
}

template<typename TXMLData>
XDOM_NODE_PTR& TDOM_MSDOMAdaptorBase<TXMLData>::GetDOMNode(void)
{
	return m_ptrDocNode;
}

template<typename TXMLData>
bool TDOM_MSDOMAdaptorBase<TXMLData>::IsInitialized(void)
{
	return m_bInitialized;
}

template<typename TXMLData>
bool TDOM_MSDOMAdaptorBase<TXMLData>::IsLoaded(void)
{
	return m_bLoaded;
}

template<typename TXMLData>
void TDOM_MSDOMAdaptorBase<TXMLData>::Clear(void)
{
...
template<typename TXMLData>
void TDOM_MSDOMAdaptorBase<TXMLData>::PackNode(XDOM_NODE_PTR & ptrNode, 
...
#endif //__TDOM_MSDOMADPTOR_INL__
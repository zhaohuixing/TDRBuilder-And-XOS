...
// CVOA_WordRows wrapper class

class CVOA_WordRows : public COleDispatchDriver
{
public:
	CVOA_WordRows(){} // Calls COleDispatchDriver default constructor
	CVOA_WordRows(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CVOA_WordRows(const CVOA_WordRows& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

...
// CVOA_WordParagraph wrapper class

class CVOA_WordParagraph : public COleDispatchDriver
{
public:
	CVOA_WordParagraph(){} // Calls COleDispatchDriver default constructor
	CVOA_WordParagraph(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CVOA_WordParagraph(const CVOA_WordParagraph& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

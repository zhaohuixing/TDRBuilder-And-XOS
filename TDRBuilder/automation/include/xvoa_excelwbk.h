...
// CVOA_ExcelWorkbook wrapper class

class CVOA_ExcelWorkbook : public COleDispatchDriver
{
public:
	CVOA_ExcelWorkbook(){} // Calls COleDispatchDriver default constructor
	CVOA_ExcelWorkbook(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CVOA_ExcelWorkbook(const CVOA_ExcelWorkbook& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

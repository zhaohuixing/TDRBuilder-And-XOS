...
// CVOA_ExcelWorkbooks wrapper class

class CVOA_ExcelWorkbooks : public COleDispatchDriver
{
public:
	CVOA_ExcelWorkbooks(){} // Calls COleDispatchDriver default constructor
	CVOA_ExcelWorkbooks(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CVOA_ExcelWorkbooks(const CVOA_ExcelWorkbooks& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

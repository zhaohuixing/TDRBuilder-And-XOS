...
// CVOA_WordCell wrapper class

class CVOA_WordCell : public COleDispatchDriver
{
public:
	CVOA_WordCell(){} // Calls COleDispatchDriver default constructor
	CVOA_WordCell(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CVOA_WordCell(const CVOA_WordCell& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

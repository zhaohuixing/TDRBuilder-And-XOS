...
// CVOA_WordParagraphs wrapper class

class CVOA_WordParagraphs : public COleDispatchDriver
{
public:
	CVOA_WordParagraphs(){} // Calls COleDispatchDriver default constructor
	CVOA_WordParagraphs(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CVOA_WordParagraphs(const CVOA_WordParagraphs& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

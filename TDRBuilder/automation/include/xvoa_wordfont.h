...
// CVOA_WordFont wrapper class

class CVOA_WordFont : public COleDispatchDriver
{
public:
	CVOA_WordFont(){} // Calls COleDispatchDriver default constructor
	CVOA_WordFont(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CVOA_WordFont(const CVOA_WordFont& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

...
// CVOA_ExcelWorksheets wrapper class

class CVOA_ExcelWorksheets : public COleDispatchDriver
{
public:
	CVOA_ExcelWorksheets(){} // Calls COleDispatchDriver default constructor
	CVOA_ExcelWorksheets(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CVOA_ExcelWorksheets(const CVOA_ExcelWorksheets& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

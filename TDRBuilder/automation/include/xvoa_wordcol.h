...
// CVOA_Column wrapper class

class CVOA_Column : public COleDispatchDriver
{
public:
	CVOA_Column(){} // Calls COleDispatchDriver default constructor
	CVOA_Column(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CVOA_Column(const CVOA_Column& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

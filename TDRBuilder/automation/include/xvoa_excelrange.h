...
// CVOA_ExcelRange wrapper class

class CVOA_ExcelRange : public COleDispatchDriver
{
public:
	CVOA_ExcelRange(){} // Calls COleDispatchDriver default constructor
	CVOA_ExcelRange(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CVOA_ExcelRange(const CVOA_ExcelRange& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

...
// CVOA_Selection wrapper class

class CVOA_Selection : public COleDispatchDriver
{
public:
	CVOA_Selection(){} // Calls COleDispatchDriver default constructor
	CVOA_Selection(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CVOA_Selection(const CVOA_Selection& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

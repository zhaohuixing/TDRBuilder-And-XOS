...
// CVOA_WordRange wrapper class

class CVOA_WordRange : public COleDispatchDriver
{
public:
	CVOA_WordRange(){} // Calls COleDispatchDriver default constructor
	CVOA_WordRange(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CVOA_WordRange(const CVOA_WordRange& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

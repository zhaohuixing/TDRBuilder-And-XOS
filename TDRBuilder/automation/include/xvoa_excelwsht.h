...
// CVOA_ExcelWorksheet wrapper class

class CVOA_ExcelWorksheet : public COleDispatchDriver
{
public:
	CVOA_ExcelWorksheet(){} // Calls COleDispatchDriver default constructor
	CVOA_ExcelWorksheet(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CVOA_ExcelWorksheet(const CVOA_ExcelWorksheet& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

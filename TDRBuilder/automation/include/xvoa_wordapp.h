...
// CVOA_WordApp wrapper class

class CVOA_WordApp : public COleDispatchDriver
{
public:
	CVOA_WordApp(){} // Calls COleDispatchDriver default constructor
	CVOA_WordApp(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CVOA_WordApp(const CVOA_WordApp& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}

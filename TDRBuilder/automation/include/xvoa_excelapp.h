...
// CVOA_ExcelApp wrapper class

class CVOA_ExcelApp : public COleDispatchDriver
{
public:
	CVOA_ExcelApp(){} // Calls COleDispatchDriver default constructor
	CVOA_ExcelApp(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CVOA_ExcelApp(const CVOA_ExcelApp& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
